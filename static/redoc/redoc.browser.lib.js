...
`,Fc=ee(Ic)`
  margin: 0 5px 0 0;
`,Bc=ee((t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(Nc,{className:o,onClick:i||void 0},e.createElement(Fc,{type:s},yt(s)),e.createElement(Ai,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(qc,{$deprecated:a},r),a?e.createElement(Pi,{type:"warning"}," ",_("deprecated")," "):null)}))`
  padding: 10px;
  border-radius: 2px;
  margin-bottom: 4px;
  line-height: 1.5em;
